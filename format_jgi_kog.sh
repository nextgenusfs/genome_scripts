...
$new_header"
    ...
    Now you can submit $4.proteins.fasta and $4.smurf.txt to http://jcvi.org/smurf/upload.php

    And you can submit $4.gbk to AntiSmash (http://antismash.secondarymetabolites.org)

    You likely want to delete the folder $dir/$4, unless you need the intermediate files.
